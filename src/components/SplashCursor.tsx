...
/**
 * Fluid-simulation cursor trail (WebGL), ported from React Bits
 * (https://reactbits.dev/backgrounds/splash-cursor). Renders a fixed,
 * full-viewport, pointer-events-none canvas — it reacts to mouse/touch
 * movement anywhere on the page, not just where it's mounted in the tree.
 */
...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    const blit = ((): ((target: any, clear?: boolean) => void) => {
